...
export function PlanReviewPreview() {
  ...
  return <div className="review-grid">
    ...
    <section className="card boundaries">
      <div className="delegate-heading"><span>Your approval</span><h2>Set the exact authority</h2><p>Gemini cannot contact anyone, approve this version, or decide that the mission is done.</p></div>
      <ApprovalPanel
        planVersion={1}
