...
export function PlanReviewPreview() {
  ...
  return <div className="review-grid">
    <nav className="review-steps" aria-label="Follow-up progress"><div data-complete="true"><span>✓</span><strong>Evidence read</strong></div><div data-current="true"><span>2</span><strong>Review and approve</strong></div><div><span>3</span><strong>ActionOS follows through</strong></div></nav>
    <section className="card contract-card">
      <div className="review-readiness" data-ready="true"><span aria-hidden="true">✓</span><div><strong>Ready for your boundary./strong><p>Gemini found the critical details. Check them before delegating.</p></div></div>
      ...
      <dl className="facts"><div><dt>Amount</dt><dd>USD 59.00</dd></div><div><dt>Reference</dt><dd>ORDER-1842</dd></div><div><dt>Due</dt><dd>Aug 21, 2026</dd></div><div><dt>Follow-up</dt><dd>Accelerated after boundary./dd></div></dl>
    ...
    <section className="card boundaries">
      <div className="delegate-heading"><span>Your boundary./span><h2>Set the exact authority</h2><p>Gemini cannot contact anyone, approve this version, or decide that the mission is done.</p></div>
      <ApprovalPanel
        planVersion={1}
        ...
        onApprove={() => undefined}
      />
      <details className="boundary.details"><summary>Review channel, exact message and shared data</summary><p>Controlled endpoint · up to 3 approved follow-ups · no bulk outreach.</p></details>
    </section>
  </div>;
}
