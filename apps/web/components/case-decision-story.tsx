...
export function CaseDecisionStory({ detail }: { readonly detail: ConsumerCaseDetail }) {
  ...
  return <section className="case-story" aria-label={tr("How DueBack decides", "Cómo decide DueBack", "Como o DueBack decide")}>
