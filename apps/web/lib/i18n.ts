...
const en = {
  ...
  home: {
    ...
    actionosQuote: "“I will execute this sequence within approved limits.”", actionosText: "The agent acts, verifies outcomes, retries safely, and returns when the state is achieved.",
  ...
  privacy: {
    ...
    before: "Before execution", beforeText: "No side-effects occur without plan boundary.", activated: "When executing", activatedText: "Only authorized capabilities can access external systems.",
...
const es: Messages = {
  ...
  home: {
    eyebrow: "El agente que hace el seguimiento por vos", title: "Dejá de perseguir a las empresas por lo que ya prometieron.", lede: "ActionOS lee la promesa, hace el seguimiento dentro de los límites que aprobás y mantiene el caso abierto hasta que la evidencia sea suficiente.", handoff: "Delegar un seguimiento", how: "Ver cómo funciona", trust: "Sin acceso a tu correo · Nada se envía sin aprobación · Detenelo cuando quieras", example: "Caso de ejemplo", refund: "Reembolso · USD 59", order: "Pedido 1842", outcome: "RESULTADO", receive: "Recibir el reembolso prometido", understood: "Promesa comprendida", extracted: "Monto, referencia y fecha extraídos", approved: "Seguimiento aprobado", approvedDetail: "Una acción, sólo los datos aprobados", rejected: "“Solicitud recibida” rechazada", rejectedDetail: "Un acuse de recibo no es una resolución", confirmed: "Reembolso confirmado", confirmedDetail: "Se recibió evidencia firmada coincidente", proof: "Prueba aceptada", complete: "Caso completo", contrast: "Los sistemas de las empresas cierran tickets. Los recordatorios te devuelven el trabajo.", contrastTitle: "ActionOS mantiene tu promesa abierta hasta que la evidencia de la empresa coincida.", why: "Por qué usar ActionOS", giveTitle: "Dale lo que tengas", giveText: "Pegá un mensaje, describí la situación o subí una captura, foto o PDF.", approveTitle: "Aprobá los límites", approveText: "Revisá la acción, el destinatario, los datos, los límites y la prueba requerida antes de que ocurra algo.", attentionTitle: "Recuperá tu atención", attentionText: "ActionOS sigue trabajando ante demoras y acuses hasta recibir evidencia verificable.", difference: "La diferencia", notChat: "No es otro chatbot. Es un caso que permanece abierto.", reminder: "RECORDATORIO", reminderQuote: "“Mañana escribile a la tienda.”", reminderText: "Todavía tenés que recordar, escribir, enviar, revisar y decidir.", actionosQuote: "“Haré el seguimiento dentro de estos límites.”", actionosText: "El agente actúa, rechaza evidencia débil, reintenta con seguridad y vuelve cuando te necesita.", recipe: "Flujo activo · seguimiento empresarial", tired: "¿Qué te cansaste de perseguir?", start: "Empezá con un reembolso, cancelación, reemplazo, entrega o documento prometido.", live: "Probar la experiencia"
  },
  intake: {
    eyebrow: "Prueba de cumplimiento para agentes cotidianos", title: "Decí qué tiene que pasar. ActionOS lo mantiene en movimiento.", lede: "Convertí resultados pendientes en un plan aprobado con límites, seguimiento autónomo y evidencia suficiente para dar el trabajo por terminado.", trust: "Vos aprobás los límites", rules: "Las reglas verifican el resultado", useCases: "Casos de uso de ActionOS", followup: "Seguimiento empresarial · activo", appointments: "Turnos · próximamente", documents: "Documentos · próximamente", after: "Después de tu aprobación", contactTitle: "ActionOS contacta a la contraparte", contactText: "usando únicamente el destinatario y la acción que aprobaste.", openTitle: "Mantiene el caso abierto", openText: "cuando una respuesta sólo dice “solicitud recibida”.", returnTitle: "Volvés únicamente para una decisión o resultado.", returnText: "Esta demo actualiza automáticamente la página del caso.", demoTitle: "Demo activa:", demoText: "el adaptador HTTP controlado es la opción segura. Los usuarios identificados pueden elegir explícitamente el piloto de correo administrado con lista permitida durante la revisión.", principles: "Principios de ActionOS", geminiTitle: "Gemini comprende el resultado", geminiText: "Mensajes, capturas, PDF y tu propio contexto.", boundariesTitle: "Vos definís cada límite", boundariesText: "Revisá primero la acción, destinatario, datos, canal y prueba.", proofTitle: "La prueba decide qué cuenta", proofText: "Un acuse de recibo no es cumplimiento. La evidencia debe coincidir."
  },
  privacy: {
    eyebrow: "Privacidad de ActionOS", title: "Sólo la promesa que elegís compartir.", lede: "ActionOS no lee tu correo. El texto y los archivos originales se eliminan después de una extracción exitosa y tienen una retención máxima de 24 horas. El caso estructurado vence siete días después del ingreso y su TTL automático se programa como máximo 30 días después. Podés eliminar antes un caso activado desde sus controles.", before: "Antes de activar", beforeText: "No se envía nada a ninguna empresa.", activated: "Al activar", activatedText: "Sólo se comparten la referencia, el monto y la moneda incluidos en el plan aprobado.", gemini: "Procesamiento con Gemini", geminiText: "El servicio Gemini de Google procesa la fuente que enviás para extraer un borrador. Gemini no tiene herramientas de contacto y no puede aprobar, enviar ni cerrar el caso.", deletion: "Eliminación", deletionText: "Eliminar borra el caso y sus registros operativos relacionados. Se conserva hasta 30 días un recibo de eliminación con hash para auditar la solicitud sin retener el contenido.", logs: "Registros", logsText: "Los registros operativos usan identificadores y hashes, no los archivos ni el texto completo de la promesa.", limitation: "Límite de la demo", limitationText: "El comercio es un entorno controlado, no una empresa real. Su confirmación no prueba una liquidación bancaria."
  },
  steps: { analysisEye: "Paso 1 · Comprensión del objetivo", analysisTitle: "Tu misión se planificó de forma segura.", analysisText: "Gemini descompone el objetivo; reglas deterministas validan los requisitos.", reviewEye: "Paso 2 · Nada se ejecuta sin vos", reviewTitle: "Revisá lo que planeó ActionOS.", reviewText: "Corregí cualquier parámetro y aprobá los límites de ejecución.", resultEye: "Paso 3 · Ejecución autónoma", resultTitle: "ActionOS conduce el flujo de trabajo.", resultText: "La consola de la misión se actualiza cuando se invocan capacidades y se verifica el estado.", exceptionEye: "Sólo cuando el criterio humano importa", exceptionTitle: "ActionOS necesita una intervención." }
};
