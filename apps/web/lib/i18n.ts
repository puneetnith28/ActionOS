...
const es: Messages = {
  ...
  steps: { analysisEye: "Paso 1 · Análisis de evidencia", analysisTitle: "Tu promesa ya está en movimiento de forma segura.", analysisText: "Gemini extrae candidatos; reglas deterministas comprueban qué necesita tu revisión.", reviewEye: "Paso 2 · Nada ocurre sin vos", reviewTitle: "Revisá lo que ActionOS entendió.", reviewText: "Corregí lo que esté mal y elegí exactamente qué puede hacer el agente.", resultEye: "Paso 3 · Seguimiento", resultTitle: "ActionOS está ocupándose del seguimiento.", resultText: "Esta página se actualiza cuando responde la contraparte y se verifica la evidencia.", exceptionEye: "Sólo cuando tu criterio importa", exceptionTitle: "ActionOS necesita una decisión." }
};
...
const pt: Messages = {
  ...
  steps: { analysisEye: "Etapa 1 · Análise de evidência", analysisTitle: "Sua promessa está em movimento com segurança.", analysisText: "O Gemini extrai candidatos; regras determinísticas verificam o que precisa da sua revisão.", reviewEye: "Etapa 2 · Nada acontece sem você", reviewTitle: "Revise o que o ActionOS entendeu.", reviewText: "Corrija o que estiver errado e escolha exatamente o que o agente pode fazer.", resultEye: "Etapa 3 · Acompanhamento", resultTitle: "O ActionOS está cuidando do acompanhamento.", resultText: "Esta página é atualizada quando a contraparte responde e a evidência é verificada.", exceptionEye: "Somente quando seu julgamento importa", exceptionTitle: "O ActionOS precisa de uma decisão." }
};
