...
<title>DueBack Merchant Sandbox</title><style>body{font:16px system-ui;max-width:760px;margin:4rem auto;padding:0 1rem;color:#16211b}strong{color:#9a3412}.card{padding:1.5rem;border:1px solid #d7ddd9;border-radius:16px;background:#f8faf9}code{background:#e9eeeb;padding:.15rem .35rem;border-radius:4px}</style></head>
