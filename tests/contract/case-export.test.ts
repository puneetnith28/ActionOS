...
describe("safe case export", () => {
  it("contains the decision and limitation without access capabilities or raw identifiers", () => {
    ...
    const text = caseExportText(item, [{
      candidate: {
        evidenceId: "evidence_private_1234", caseId: draft.caseId, level: "MERCHANT_CONFIRMED",
    ...
    for (const forbidden of [draft.caseId, draft.ownerId, "private@example.com", "case+secret", "sha256:", "corr_secret", "evidence_private"])
