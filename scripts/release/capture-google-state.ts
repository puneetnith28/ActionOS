...
const baseUrl = process.env.DUEBACK_DEPLOYED_URL ?? "https://bulbasour-503317.web.app";
const authDirectory = resolve(".auth");
const outputPath = resolve(process.env.DUEBACK_AUTH_STATE ?? ".auth/google-owner.json");
